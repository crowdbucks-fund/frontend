/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c7ad4506fc9fb28e7746eacb3607af00)
// Runtime types generated with workerd@1.20250816.0 2025-05-05 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		APP_KEY: string;
		NEXT_PUBLIC_PLATFORM_FOOTER_INFO: string;
		BSKY_OAUTH_CLIENT_URI: string;
		BSKY_OAUTH_CLIENT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_API_BASE" | "NEXT_PUBLIC_APP_URL" | "APP_KEY" | "NEXT_PUBLIC_PLATFORM_FOOTER_INFO" | "BSKY_OAUTH_CLIENT_URI" | "BSKY_OAUTH_CLIENT_ID" | "NEXT_PUBLIC_POSTHOG_KEY" | "NEXT_PUBLIC_POSTHOG_HOST" | "POSTHOG_API_KEY" | "POSTHOG_ENV_ID">> {}
}
